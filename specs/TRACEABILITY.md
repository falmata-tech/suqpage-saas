...
| Managed client requests, staff fulfillment, preview approval, and publication | FE-003 | BE-003 | DEP-003 | Planned: request/application ports, private attachments, role assignments, client/team workspaces, revision publication | Planned: `scripts/test-requests.ts`, `scripts/test-revisions.ts`, `tests/acceptance/requests.spec.ts`, operations/release/container gates | ready |
