...
| Managed client requests, staff fulfillment, preview approval, and publication | FE-003 | BE-003 | DEP-003 | Active increment: attachment-free public interest, admin review, authenticated attachment foundation, schema migrations 2–3. Remaining: invitation, client/team/manager workspaces and revision publication | `scripts/test-requests.ts`, `scripts/http-smoke.mjs`, `scripts/test-operations.mjs`, `tests/acceptance/app.spec.ts`; revision/cutover gates remain | in_progress |
