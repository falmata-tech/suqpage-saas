...
status: done
related: [FE-001, FE-003, FE-013, FE-017, FE-018, FE-020, FE-024, BE-019, BE-020, DEP-016, DEP-017, ADR-0011]
owners: [product, frontend, design]
last_updated: 2026-08-01
change_level: L3
---

# FE-021 - Geographic Showroom map and weekly industry Expo
...
- A compact marker preview and permanent **Visit Showroom** destination.
...
- Map zoom, selected cluster/marker, open city gateway, and City Showroom transform
...
Scenario: Isolated business remains independently discoverable
  ...
  AND activating it opens a compact preview with a Visit Showroom action
...
Scenario: Sunday presents selected businesses live
  ...
  THEN it identifies the MirtPage TikTok livestream
  AND selected featured businesses have permanent Visit Showroom destinations
...
Scenario: Local map assets fail
  ...
  AND the Expo and every matching permanent Showroom remain reachable
```
...
| Desktop/390px/320px map, City Showroom, and Expo layout | visual/browser | `scripts/capture-discovery-visuals.mjs` |
