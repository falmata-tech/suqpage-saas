---
id: DEP-016
title: Permanent City Showroom pre-production cutover
status: deprecated
...
# DEP-016 - Permanent City Showroom pre-production cutover
...
- Each active industry has enough eligible businesses to exercise at least one
  qualifying three-business City Showroom; the complete cohort spans multiple cities
  and regions.
...
- `env MIRTPAGE_SUPPRESS_CREDENTIAL_OUTPUT=1 npm run reset` created 58 active
  small-business Showrooms, 48 lightweight discovery fixtures, six industries, one
