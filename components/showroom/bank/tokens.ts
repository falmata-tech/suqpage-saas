    ...
    Object.values(SHOWROOM_DESIGN_SYSTEMS).map((system) => [
      system.id,
      {
        ...
        variables: {
          ...
          "--bank-layer": system.colors.layer,
          ...
          "--bank-section-alt": system.colors.layer,
          "--bank-section-strong": system.colors.strong,
          "--bank-on-strong": system.colors.onStrong,
          "--bank-inverse": system.colors.inverse,
          "--bank-on-inverse": system.colors.onInverse,
