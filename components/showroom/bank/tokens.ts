...
export const SHOWROOM_BANK_TOKEN_STYLES = withExperienceVariables({
  ...
  "cosmetic-laboratory": {
    id: "cosmetic-laboratory",
    label: "Cosmetic laboratory",
    variables: {
      "--bank-bg": "#f5f7f3",
      "--bank-surface": "#ffffff",
      "--bank-ink": "#17211d",
