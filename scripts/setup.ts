...
function seedCatalog(handle: string, collectionName: string, categoryNames: string[], products: any[]) {
  ...
  products.forEach((p, i) => {
    const productId = Number(addProduct.run(businessId, collectionId, cats.get(p.category)!, p.name, p.slug, p.eyebrow, p.description, p.image, p.availability || "available", p.stock ?? 10, i).lastInsertRowid);
    (p.options || []).slice(0,4).forEach((g:any, gi:number) => {
      const groupId = Number(addGroup.run(productId, g.name, gi).lastInsertRowid);
      g.values.forEach((v:string) => addValue.run(groupId, v, p.stock ?? 10));
    });
  });
}

seedCatalog("alhayabrand", "Signature Collection", ["Niqabs","Hijabs","Abayas","Jilbabs"], [
  {name:"Noor Collection",slug:"noor-collection",category:"Niqabs",eyebrow:"Five-piece niqab",description:"A versatile five-piece set with a flowing finish.",image:"/uploads/seed/alhaya/niqab-noor.jpg",stock:18,options:[{name:"Color",values:["Deep Black","Chocolate","Pearl Grey","Sand Beige"]},{name:"Set",values:["Five-piece set"]}]},
  {name:"Ayla Collection",slug:"ayla-collection",category:"Niqabs",eyebrow:"Soft layered niqab",description:"A softly structured niqab designed for comfortable daily wear.",image:"/uploads/seed/alhaya/niqab-ayla.jpg",stock:12,options:[{name:"Color",values:["Forest Olive","Warm Sand","Dusty Mint"]}]},
  {name:"Mariam Hijab",slug:"mariam-hijab",category:"Hijabs",eyebrow:"Everyday hijab",description:"A lightweight hijab with natural drape.",image:"/uploads/seed/alhaya/hijab-mariam.jpg",stock:25,options:[{name:"Color",values:["Mocha","Cream","Mushroom"]},{name:"Size",values:["1m × 2m"]}]},
  {name:"Safwa Abaya",slug:"safwa-abaya",category:"Abayas",eyebrow:"Refined abaya",description:"A clean silhouette with understated detailing.",image:"/uploads/seed/alhaya/abaya-safwa.jpg",stock:9,options:[{name:"Color",values:["Midnight","Chocolate","Stone Grey"]},{name:"Size",values:["52","54","56","58"]}]},
  {name:"Layan Jilbab",slug:"layan-jilbab",category:"Jilbabs",eyebrow:"Two-piece jilbab",description:"An easy, full-coverage set with a balanced drape.",image:"/uploads/seed/alhaya/jilbab-layan.jpg",stock:14,options:[{name:"Color",values:["Olive","Midnight Navy","Warm Taupe"]},{name:"Size",values:["S/M","L/XL"]}]}
]);

seedCatalog("usashopet", "Beauty Shelf", ["Skincare","Wellness","Hair","Body"], [
  {name:"CeraVe Hydrating Facial Cleanser",slug:"cerave-hydrating-cleanser",category:"Skincare",eyebrow:"Gentle cleanse",description:"A daily cleanser for normal-to-dry skin.",image:"/uploads/seed/usashopet/gentle-cleanser.jpg",stock:20,options:[{name:"Size",values:["8 oz","12 oz","16 oz"]}]},
  {name:"TruSkin Vitamin C Facial Serum",slug:"truskin-vitamin-c",category:"Skincare",eyebrow:"Brightening serum",description:"A lightweight vitamin C serum for a simple morning routine.",image:"/uploads/seed/usashopet/vitamin-c.jpg",stock:15,options:[{name:"Size",values:["1 fl oz"]}]},
  {name:"Vital Proteins Collagen Peptides",slug:"vital-proteins-collagen",category:"Wellness",eyebrow:"Daily wellness",description:"Unflavored collagen peptides for drinks and recipes.",image:"/uploads/seed/usashopet/collagen.jpg",stock:10,options:[{name:"Size",values:["10 oz","20 oz"]}]},
  {name:"One A Day Women's Multivitamin",slug:"one-a-day-women",category:"Wellness",eyebrow:"Daily vitamins",description:"A familiar daily multivitamin option.",image:"/uploads/seed/usashopet/daily-vitamins.jpg",stock:17,options:[{name:"Count",values:["100 tablets","200 tablets"]}]},
  {name:"Mielle Rosemary Mint Scalp & Hair Strengthening Oil",slug:"mielle-rosemary-oil",category:"Hair",eyebrow:"Hair care",description:"A scalp and hair oil for a focused care routine.",image:"/uploads/seed/usashopet/hair-care.jpg",stock:13,options:[{name:"Size",values:["2 fl oz"]}]},
  {name:"e.l.f. Halo Glow Liquid Filter",slug:"elf-halo-glow",category:"Skincare",eyebrow:"Complexion",description:"A glow-enhancing complexion product.",image:"/uploads/seed/usashopet/makeup.jpg",stock:11,options:[{name:"Shade",values:["1 Fair","2 Fair/Light","3 Light/Medium","4 Medium"]}]},
  {name:"Sol de Janeiro Brazilian Bum Bum Cream",slug:"sol-de-janeiro-cream",category:"Body",eyebrow:"Body care",description:"A scented body cream with a rich texture.",image:"/uploads/seed/usashopet/body-care.jpg",stock:8,options:[{name:"Size",values:["75 ml","240 ml"]}]},
  {name:"Supergoop! Unseen Sunscreen SPF 40",slug:"supergoop-unseen",category:"Skincare",eyebrow:"Daily SPF",description:"An invisible-finish sunscreen primer.",image:"/uploads/seed/usashopet/sunscreen.jpg",stock:16,options:[{name:"Size",values:["20 ml","50 ml"]}]}
]);

seedCatalog("novatech", "Flagship Collection", ["Phones","Computers","Tablets","Wearables","Audio"], [
  {name:"iPhone 17 Pro",slug:"iphone-17-pro",category:"Phones",eyebrow:"Apple flagship",description:"A professional flagship phone built around performance, camera capability and a refined pro experience.",image:"/uploads/seed/novatech/iphone-17-pro.jpg",stock:7,options:[{name:"Color",values:["Silver","Deep Blue","Cosmic Orange"]},{name:"Storage",values:["256 GB","512 GB","1 TB"]},{name:"Region",values:["United States","Middle East"]}]},
  {name:"Samsung Galaxy S26 Ultra",slug:"galaxy-s26-ultra",category:"Phones",eyebrow:"Samsung flagship",description:"A large-screen flagship with an advanced camera system and S Pen productivity.",image:"/uploads/seed/novatech/galaxy-s26-series.jpg",stock:4,availability:"limited",options:[{name:"Color",values:["Titanium Black","Titanium Silver"]},{name:"Storage",values:["256 GB","512 GB","1 TB"]}]},
  {name:"MacBook Pro 14-inch with M5",slug:"macbook-pro-m5",category:"Computers",eyebrow:"Pro computing",description:"A compact professional notebook for demanding creative and technical work.",image:"/uploads/seed/novatech/macbook-pro-m5.jpg",stock:5,options:[{name:"Memory",values:["16 GB","24 GB","32 GB"]},{name:"Storage",values:["512 GB","1 TB","2 TB"]},{name:"Color",values:["Space Black","Silver"]}]},
  {name:"iPad Pro with M5",slug:"ipad-pro-m5",category:"Tablets",eyebrow:"Portable studio",description:"A thin creative canvas for illustration, editing and mobile work.",image:"/uploads/seed/novatech/ipad-pro-m5.jpg",stock:6,options:[{name:"Size",values:["11-inch","13-inch"]},{name:"Storage",values:["256 GB","512 GB","1 TB"]},{name:"Connectivity",values:["Wi‑Fi","Wi‑Fi + Cellular"]}]},
  {name:"Apple Watch Ultra 3",slug:"apple-watch-ultra-3",category:"Wearables",eyebrow:"Adventure wearable",description:"A performance watch for training, travel and outdoor use.",image:"/uploads/seed/novatech/apple-watch-ultra-3.jpg",stock:3,availability:"limited",options:[{name:"Band",values:["Alpine Loop","Trail Loop","Ocean Band"]},{name:"Band size",values:["Small","Medium","Large"]}]},
  {name:"Sony WH-1000XM6",slug:"sony-wh-1000xm6",category:"Audio",eyebrow:"Premium audio",description:"Flagship wireless headphones with advanced noise cancellation.",image:"/uploads/seed/novatech/sony-wh-1000xm6.svg",stock:9,options:[{name:"Color",values:["Black","Platinum Silver","Midnight Blue"]}]}
]);

seedCatalog("homevibe", "Home Edit", ["Cleaning","Kitchen","Coffee","Lighting"], [
  {name:"Dyson V16 Piston Animal",slug:"dyson-v16",category:"Cleaning",eyebrow:"Whole-home cleaning",description:"A cordless vacuum designed for powerful everyday cleaning.",image:"/uploads/seed/homevibe/dyson-v16.jpg",stock:5,options:[{name:"Finish",values:["Black/Copper"]},{name:"Bundle",values:["Standard","Pet home"]}]},
  {name:"KitchenAid Artisan Series 5 Quart Tilt-Head Stand Mixer",slug:"kitchenaid-artisan",category:"Kitchen",eyebrow:"Kitchen icon",description:"A recognizable stand mixer for baking and everyday preparation.",image:"/uploads/seed/homevibe/kitchenaid-artisan.webp",stock:7,options:[{name:"Color",values:["Empire Red","Matte Black","Milkshake","Contour Silver"]}]},
  {name:"iRobot Roomba Max 705 Combo",slug:"roomba-max-705",category:"Cleaning",eyebrow:"Hands-off floor care",description:"Robot vacuum and mop support for busy homes.",image:"/uploads/seed/homevibe/roomba-max-705.webp",stock:3,availability:"limited",options:[{name:"Dock",values:["AutoWash Dock"]}]},
  {name:"Le Creuset Signature Round Dutch Oven",slug:"le-creuset-dutch-oven",category:"Kitchen",eyebrow:"Cookware classic",description:"Enameled cast iron made for slow cooking and table-ready serving.",image:"/uploads/seed/homevibe/le-creuset-dutch-oven.jpg",stock:8,options:[{name:"Size",values:["5.5 qt","7.25 qt"]},{name:"Color",values:["Flame","Cerise","Marseille","White"]}]},
  {name:"Ninja Crispi Air Fryer",slug:"ninja-crispi",category:"Kitchen",eyebrow:"Compact cooking",description:"A compact air-frying system for quick meals and reheating.",image:"/uploads/seed/homevibe/ninja-crispi.svg",stock:10,options:[{name:"Color",values:["Stone","Sage","Blue"]}]},
  {name:"Nespresso Vertuo Creatista",slug:"nespresso-vertuo-creatista",category:"Coffee",eyebrow:"Coffee ritual",description:"Vertuo coffee with integrated milk-texturing control.",image:"/uploads/seed/homevibe/nespresso-vertuo-creatista.svg",stock:4,options:[{name:"Finish",values:["Stainless Steel"]}]},
  {name:"Vitamix Ascent X5",slug:"vitamix-ascent-x5",category:"Kitchen",eyebrow:"Countertop performance",description:"A high-performance blender for smoothies, soups and prep.",image:"/uploads/seed/homevibe/vitamix-ascent-x5.svg",stock:6,options:[{name:"Color",values:["Brushed Stainless","Graphite"]}]},
  {name:"Philips Hue Play Gradient Lightstrip",slug:"philips-hue-gradient",category:"Lighting",eyebrow:"Ambient lighting",description:"A gradient lightstrip for immersive room lighting.",image:"/uploads/seed/homevibe/philips-hue-gradient.svg",stock:12,options:[{name:"Screen size",values:["55 inch","65 inch","75 inch"]}]}
]);
