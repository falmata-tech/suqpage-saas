...
async function publicMarketplaceTour(page) {
  ...
  await focus(page, page.locator("#daily-featured-title"), 3600);
  const booth = page.locator(".featured-booth:not(.featured-booth-outline)").first();
...
async function fullPlatformTour(page) {
  ...
  await focus(page, page.locator("#daily-featured-title"), 3400);
