...
const shortNarration = `Across Ethiopia, capable growers, makers, workshops, processors, and growing factories are producing goods that deserve to be easier to find. MirtPage brings them into one searchable marketplace. Visitors can move between industries, search as they type, discover businesses by location, and explore paid sponsored placements without losing the main map experience. Daily Featured Showrooms creates another path into participating enterprises, while every business keeps a permanent digital showroom. Inside a showroom, products and manufacturing capabilities are presented with clear images, practical details, and a visible production process. A customer can build an inquiry, enter an optional quantity in the terms that make sense for the product, and send it directly to the business with a required phone number. MirtPage gives Ethiopian production one clear place to be understood, trusted, and contacted.`;
