...
export default async function DiscoveryAdminPage({ searchParams }: {
  ...
  return <DashboardShell user={user} business={null}>
    <div className="dashboard-head"><div><span className="eyebrow">Public discovery</span><h1>Discovery profiles</h1><p>Manage one business&apos;s industry, approved booth image, origin, and visibility.</p></div><Link className="btn secondary" href="/discover" target="_blank">Open discovery</Link></div>
