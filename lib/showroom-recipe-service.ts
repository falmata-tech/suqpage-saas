  ...
  return {
    ...
    brief: {
      ...
      instructions: [
        ...
        "Keep adjacent about/story and process sections compositionally distinct: use opposite start/end alignment on wider screens, preserve their surface/surface-soft contrast, and avoid plaid, pinstripes, graph-paper grids, or repeated straight divider motifs.",
